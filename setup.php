 ...
 */
 ...
 if(file_exists(DIR."config.inc.php")){die("Ambrogio is already configured..");}
 ...
 $footer_grid->addCol(str_repeat(" ",6).api_tag("div","Copyright 2020-".date("Y")." &copy; <a href=\"https://github.com/Zavy86/Ambrogio\" target=\"_blank\">Ambrogio</a> - All Rights Reserved","text-right")."\n","col-xs-12");
 ...
 function setup_form(){
  ...
  $form->addField("text","bot_token","Bot Token",null,"Telegram Bot Token (clik ? for help)",null,null,null,"required");
  $form->addFieldAddonButton("https://core.telegram.org/bots#6-botfather","?",null,null,"target='_blank'");
 ...
 function setup_check(){
  ...
  $configuration->bot_token=$_REQUEST['bot_token'];
  ...
  $form->addField("hidden","bot_token",null,$configuration->bot_token);
 ...
 function setup_setup(){
  ...
  $file_content.=" // bot\n";
  $file_content.=" \$configuration->bot_token=\"".$_REQUEST['bot_token']."\";\n";
